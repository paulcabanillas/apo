object FDSocioEco: TFDSocioEco
  ...
  object dbgDatosSocioE: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'ACAPAG'#9'10'#9'CAPACIDAD DE PAGO'#9'F'
      'CONVIVID'#9'2'#9'COND. VIVIENDA'#9'F'
      'INMUEBLE'#9'90'#9'INMUEBLE'#9'F'
      'VEHICULO'#9'90'#9'VEHICULO'#9'F')
  ...
  object pnlDatosSocioEco: TPanel
    ...
    object pnlDLab: TPanel
      ...
      object TLabel
        ...
        Width = 151
        Height = 15
        Caption = 'Otros Inmuebles  -  Direcci'#243'n'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
      ...
      object TLabel
        ...
        Width = 218
        Height = 15
        Caption = 'Vehiculos  -  Marca / Modelo / A'#241'o / Placa'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
