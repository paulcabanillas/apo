object FResoluciones: TFResoluciones
  ...
  object dbgResol: TwwDBGrid
    ...
    Selected.Strings = (
      'ASOID'#9'10'#9'CODIGO~DERRAMA'#9'F'
      'ASOCODMOD'#9'10'#9'CODIGO~MODULAR'#9'F'
      'RESID'#9'2'#9'TIPO~RESOL.'#9'F'
      'ASONRES'#9'15'#9'NRO~RESOLUCION'#9'F'
      'ASOFRES'#9'11'#9'FECHA~RESOLUCION'#9'F'
