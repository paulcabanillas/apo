...
begin
  ...
  DM1.cdsDFam.Edit;
  pnlFamiliares.Height:=283;
  pnlFamiliares.Left  :=5;
  pnlFamiliares.Top   :=78;
  pnlFamiliares.Width :=772;
...
begin
  sSQL := 'SELECT ASOID, FAMAPEPAT, FAMAPEMAT, FAMNOMBRE, FAMAPENOM, '+
          ...
          'FROM APO203 WHERE ASOID='+QuotedStr(DM1.cdsAso.FieldByName('ASOID').AsString);
  DM1.FiltraCDS(DM1.cdsDFam,sSQL);

  dbgDFam.Selected.Clear;
  dbgDFam.Selected.Add('FAMAPEPAT'#9'15'#9'Apellido~Paterno');
  dbgDFam.Selected.Add('FAMAPEMAT'#9'15'#9'Apellido~Materno');
  dbgDFam.Selected.Add('FAMNOMBRE'#9'20'#9'Nombres');
  dbgDFam.Selected.Add('FAMAPENOM'#9'35'#9'Apellidos y Nopmbres');
  dbgDFam.Selected.Add('FAMRELID'#9'3'#9'Relacion');
  dbgDFam.Selected.Add('FAMDIRECC'#9'20'#9'Dirección');
  dbgDFam.Selected.Add('ZIPID'#9'6'#9'Distrito');
  dbgDFam.Selected.Add('FAMTELF'#9'8'#9'Telefono');
  dbgDFam.Selected.Add('FAMSEXO'#9'3'#9'Sexo');
  dbgDFam.Selected.Add('TIPDOCCOD'#9'3'#9'Id Tip~Docum');
  dbgDFam.Selected.Add('FAMNUMDOC'#9'10'#9'Nº~Documento');
  dbgDFam.Selected.Add('ESTCIVID'#9'3'#9'Estado~Civil');
  dbgDFam.Selected.Add('FAMFECNAC'#9'10'#9'Fecha~Nacimiento');
...
procedure TFDFam.dbgDFamKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
