  ...
  object Panel1: TPanel
    ...
    object pnlNomTrab: TPanel
      ...
      object lblSituacion: TLabel
        ...
        Width = 122
        Height = 15
        Caption = 'Situación del Aportante'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
      ...
      object pcAsociados: TPageControl
        ...
        object tsDDom: TTabSheet
          ...
          object dblcdDepto: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              'DPTOID'#9'3'#9'ID'#9'F'
              'DPTODES'#9'30'#9'Descripción'#9'F')
            DataField = 'DPTOID'
            DataSource = DM1.dsAso
          ...
          object dblcdCiudad: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              'CIUDID'#9'3'#9'ID'#9'F'
              'CIUDDES'#9'30'#9'Descripción'#9'F'
              'DPTOID'#9'3'#9'Dpto'#9'F')
            DataField = 'CIUDID'
            DataSource = DM1.dsAso
        ...
        object tsDLab: TTabSheet
          ...
          object Label6: TLabel
            ...
            Width = 146
            Height = 15
            Caption = 'Situación de la Cta Bancaria'
            Font.Charset = ANSI_CHARSET
            Font.Color = clNavy
            Font.Height = -11
            Font.Name = 'Comic Sans MS'
          ...
          object dblcdSit: TwwDBLookupCombo
            ...
            DropDownAlignment = taLeftJustify
            Selected.Strings = (
              'SITCTAID'#9'2'#9'Código'#9'F'
              'SITCTADES'#9'30'#9'Descripción'#9'F')
            DataField = 'SITCTA'
            DataSource = DM1.dsAso
        ...
        object TabSheet1: TTabSheet
          ...
          object dblcdProfesion: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              'PROFID'#9'3'#9'ID'#9'F'
              'PROFDES'#9'50'#9'Descripción'#9'F')
            DataField = 'PROFID'
            DataSource = DM1.dsAso
